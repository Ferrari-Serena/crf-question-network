...
// 19 簇语义名（401 题 Louvain 分簇后人工归纳，非算法预设）。若重跑 cluster.py 导致簇编号漂移，需复核此表。
// 中英双语：默认英文（李博士要求），点右上角 EN ⇄ 中 切换。
const CLUSTER_NAMES = {
  en: {
    0: "Real Project Value & Data Constraints",
    1: "Institution Incentives, Compliance & Governance",
    2: "Time Scales, Mobilization & Attrition Attribution",
    3: "Reputation Risk, Value Creation & Churn Measurement",
    4: "Teaching Capacity, Extra Costs & Grade Preferences",
    5: "School Power, Access & Bargaining Asymmetry",
    6: "Governance & Stakeholder Salience",
    7: "Course Scaffolding & Grade-Level Projects",
    8: "Success Criteria, Accountability & Outcome Measurement",
    9: "AI, Transaction Costs & Student Signals",
    10: "Value Realization Lag, Repetition & Course Distinctiveness",
    11: "Firm Efficiency & Commitment Signals",
    12: "TA Scalability & Continuity",
    13: "Mechanism Design & Governance Theory",
    14: "Multi-School Costs & Project Budgets",
    15: "Firm Types & Incentive Heterogeneity",
    16: "Try-Before-You-Buy, Signaling & Screening",
    17: "Attrition, Sustainability & Time Mismatch",
    18: "Output Ownership & Portability",
  },
  cn: {
    0: "真实项目·价值感知与数据约束",
    1: "院系激励·合规与治理",
